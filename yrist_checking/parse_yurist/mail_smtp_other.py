...
def smtp(message, email):
    ...
    for i in Path('/home/specit').glob('2022-11-20_check.xlsx'):
        with open (i, 'rb') as f:
...
# smtp(message)
smtp('Таблица с результатом проверки.\n' + 'Файл check.xlsx во вложении.', ['132@maverik.ru', '6201@maverik.ru', '6501@maverik.ru', '115@maverik.ru', '107@maverik.ru'])
